...
class NEURAL_NETWORK: 
    ...
    def Update(self): 
        for x in self.neurons.keys(): 
            if self.neurons[x].Is_Sensor_Neuron(): 
                self.neurons[x].Update_Sensor_Neuron()
            else: 
                self.neurons[x].Update_Hidden_Or_Motor_Neuron(self.neurons, self.synapses)
